...
- [x] WC-B5-T7: 06_DECISION_MAKING.md 改訂 @sonnet
- [x] WC-B5-T8: decision-making.md 改訂 @sonnet
- [x] WC-B5-T9: ADR-0006 Glossary 追記 @sonnet
- [x] WC-B5-T10: 統合テスト（E2E） @sonnet
- [x] WC-B5-T11: メトリクス計測環境検出 @sonnet
