...
- バージョン: 1.3.0
- 作成日: 2026-06-11
- 改訂日: 2026-06-13（PM-G1 承認記録・W2-T1 スモーク行修正（DW プローブ撤回）。PM 承認済み）
- 改訂履歴: 2026-06-13 v1.3.0（PM-G1 承認記録・W2-T1 スモーク行修正（DW プローブ撤回））/ 2026-06-12 v1.2.0（W0 結果反映: W0-T2 起票・W2-T1 検証手段追記・DW 置き換え見送り記録・Plan B 確定反映。PM 承認済み）/ 2026-06-12 v1.1.0（design v0.3.0 / requirements v1.2.0 整合対応）
- ステータス: Draft（PM 承認待ち）
