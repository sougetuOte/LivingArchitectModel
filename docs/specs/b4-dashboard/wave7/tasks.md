...
- ステータス: **Approved**（v0.2.1 PM 最終承認 2026-06-27 / 3 文書セット一括 / BUILDING 遷移可）
- 根拠文書:
...
| **W7-B5-T46** | 既存テスト期待値更新（`test_v4_view*.py` / `test_dashboard_integration*.py` / 誤抽出行削減反映） | M | Data | Sonnet (L2) |
