...
**Status**: confirmed（L1 統括確定）
**Source**: rubric-draft.md v0.1.0
**Task Slug**: w7-t2b-large-route-demo
**Route**: large（L1 → l2-foreman → l3-executor 三層）

---

# rubric: w7-t2b-large-route-demo

> **注記**: 本ファイルは SKILL.md フロー[2] において L1 統括が `rubric-draft.md` から
> 確定生成した受入条件。grader が機械判定する正本。
