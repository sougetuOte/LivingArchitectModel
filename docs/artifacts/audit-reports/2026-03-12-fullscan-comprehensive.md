...
| ID | 等級 | ファイル | 内容 |
|----|------|---------|------|
| B-C1 | PM | `v4.0.0-immune-system-design.md:627-630` | 削除済みコマンド（daily, full-save, impact-analysis, security-review）への変更指示が残存 |
...
| ID | 等級 | ファイル | 内容 |
|----|------|---------|------|
| B-W1 | PM | `v4.0.0-immune-system-design.md:657` | 「変更不要」リストに削除済みコマンド（focus, full-load, adr-create） |
| B-W2 | PM | `feat-v4.0.0-immune-system.md` | 中間成果物が `docs/specs/` に残置。`docs/artifacts/` に移動推奨 |
| B-W3 | SE | `lam-orchestrate-design.md` | 参照 Claude Code バージョンが古い + ui-design-guide 未記載 |

### Info

| ID | 等級 | 内容 |
|----|------|------|
| B-I1 | PG | `v4.0.0-immune-system-design.md` 未解決事項の番号欠番 |
