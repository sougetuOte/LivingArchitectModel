...
| 4 | **計器に書き込みうる検証は隔離の実効を先に確認する**（**2026-08-20 に半分消化** —— テスト経路は **R3 機構 #8** へ。**手動経路の分のみ在庫に残る** / 下記注参照） | **1 件**（2026-08-17 / `pre-compact-fired` 汚染） | 2026-08-17（**2026-08-20 更新**） | `retro-2026-08-17.md` P1 / `prescription-audit-2026-08-20.md` |
