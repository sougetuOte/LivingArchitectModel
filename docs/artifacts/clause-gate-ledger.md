...
**§1.1 の禁止条項**: 「同時更新義務 = 有」の機構は R3 に置けない（`rule-002` 型の恒常税を新規に作らない）。**上記 7 件はいずれも「無」**（本行の件数は 2026-07-27 に「2 件」から更正 —— 機構 #3・#4 追加時に追随していなかった / 2026-08-17 に機構 #7 追加で 6 → 7）。
...
| 4 | **計器に書き込みうる検証は隔離の実効を先に確認する** | **1 件**（2026-08-17 / `pre-compact-fired` 汚染） | 2026-08-17 | `retro-2026-08-17.md` P1 |
