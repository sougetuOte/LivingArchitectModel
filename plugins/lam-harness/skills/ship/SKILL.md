...
- **受け手には制約 1 つを必ず付ける** (時間がない / 文脈を知らない / 前提が 1 個抜けている 等 / `docs/internal/08_EXECUTION_DISCIPLINE.md` §5.4 ガード 5)
...
の 2 行を残す (形骸化ガード外形証跡 / `docs/internal/08_EXECUTION_DISCIPLINE.md` §5.4 ガード 4)。
