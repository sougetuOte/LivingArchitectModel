...
| Atom | 要件の側面 | 種別 |
|------|-----------|------|
| R-A1 | [機能要件1] | Functional |
| R-A2 | [機能要件2] | Functional |
| R-A3 | [非機能要件1] | Non-Functional |

### 依存関係
- R-A2 は R-A1 の完了を前提とする
- R-A3 は R-A1, R-A2 の両方に適用される制約
...
**効果**:
- Step 2 の構造化が容易になる
- Step 3 の 3 Agents 検証を Atom 単位で実施可能
- 要件漏れの防止
