...
詳細ガード (同型構文検出 / 「詰まる瞬間」検出 3 回連続閾値 / 検知修正 1 文完結禁止) は `docs/private/fable-l3-protocol.md` §5.4 参照。
...
詳細ガード (同型構文検出 / 「詰まる瞬間」検出 3 回連続閾値) は `docs/private/fable-l3-protocol.md` §5.4 参照。
