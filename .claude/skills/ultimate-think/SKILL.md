...
SSOT は `docs/internal/06_DECISION_MAKING.md` に維持。本スキルはそのラッパー。
...
`06_DECISION_MAKING.md` Section 5（AoT）に従い:
...
`06_DECISION_MAKING.md` Section 1-3（Three Agents）に従い:
...
- `docs/specs/ultimate-think.md` — 機能仕様書（FR/NFR/テスト観点）
