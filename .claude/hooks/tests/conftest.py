...
# make_default_state / write_state は loop_state_helpers.py へ移動 (2026-07-20)。
# `from conftest import ...` は統合 pytest 実行時に他 test root の conftest に
# shadow されるため、一意 basename モジュールからの import に統一した。
