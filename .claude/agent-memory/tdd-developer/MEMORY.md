...
- [B-5 Wave C Stage 2 gabriel 実装](project_b5_wc_stage2_gabriel.md) — gabriel.md subagent + 出力契約テスト16件・クロスフィールド制約は専用バリデータで例外送出・Spike T2 bias防御文言埋め込み・jsonschema導入済み確認
